...
function mainTimline() {
  ...
  tlStageBlock.to("#flipMe", {duration:1, stagger:0.35, autoAlpha:1, delay:1, ease:"Power4.easeInOut"},1.25);
  tlStageBlock.to("#header, #footer, .marquee", {duration:3, stagger:0.35, autoAlpha:1, delay:1, ease:"Power4.easeInOut"},.5);
  tlStageBlock.to("#master_controls", {duration:3, stagger:0.35, autoAlpha:1, ease:"Power4.easeInOut"},3);
  ...
  // #header, #footer, .marquee,  #master_controls
...
function mouseClickPlayer(){
  ...
  // tlExpand.to("#header, #master_controls, .marquee, #footer, #slider_cont", {duration:3, stagger:0.2, autoAlpha:1, delay:1, ease:"Power4.easeInOut"},0);
  tlStageBlock.seek("myLabel");
